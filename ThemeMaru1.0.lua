local ui =  game:GetService("CoreGui"):FindFirstChild("redui") if ui then ui:Destroy() end
	...
	function create:Win(text)
		...
		MainSceen.BackgroundColor3 = Color3.fromRGB(32, 32, 32)
		...
		ClickFrame.BackgroundColor3 = Color3.fromRGB(32, 32, 32)
		...
		MainSceen2.BackgroundColor3 = Color3.fromRGB(32, 32, 32)
		...
		ScolTapBarFrame.BackgroundColor3 = Color3.fromRGB(32,32,33)
		...
		function create:Notifile(titel,text,delays)
		  ...
		  imagenoti.Image = "https://www.roblox.com/asset-thumbnail/image?assetId=7578496318&width=0&height=0&format=png"
			...
			txdlid.BackgroundColor3 = Color3.fromRGB(0, 204, 204)
			...
			LableFrame.BackgroundColor3 = Color3.fromRGB(0, 204, 204)
			...
			TextNoti.BackgroundColor3 = Color3.fromRGB(0, 204, 204)
			TextNoti.Size =UDim2.new(0, 260, 0,25 )
			TextNoti.Font = Enum.Font.GothamBold
			TextNoti.Text = text
			TextNoti.TextColor3 = Color3.fromRGB(128, 128, 128)
